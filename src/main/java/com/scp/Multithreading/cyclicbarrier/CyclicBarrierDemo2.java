...
public class CyclicBarrierDemo2 {
	...
	public static void main(String[] args) {
		...
		/*BarrierThreadHandler barrierThreadHandler3 = new BarrierThreadHandler(barrier, 1000);
		barrierThreadHandler3.setName("Dev Team 3");
		BarrierThreadHandler barrierThreadHandler4 = new BarrierThreadHandler(barrier, 3000);
		barrierThreadHandler4.setName("Dev Team 4");
		
		barrierThreadHandler3.start();
		barrierThreadHandler4.start();*/
	}
